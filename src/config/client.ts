 ...
 *   VITE_CHROME_STYLE  = "mono"                 (opcional — chrome monocromático estilo Fukuda;
 *                                                 sem essa env, o chrome continua como sempre foi)
 */
export const CLIENT = {
  ...
  chromeMono: (import.meta.env.VITE_CHROME_STYLE as string | undefined)?.trim().toLowerCase() === 'mono',
}
